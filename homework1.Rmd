...
my_bound<-V_bound(li=1:2, lb=c(50,0))

model_create <-OP(objectiveFunction, L_constraint(constraintMatrix, const_directions,constraintValues), maximum = TRUE, bounds = my_bound)
